...
namespace PPSystem
{
    public partial class ViewPersonalityQstn : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            string query = "SELECT * FROM [PersonalityQuestion]";
        ...
        {
            // Optional: Implement if you want to fill fields for editing based on selection.
            // Example:
            // GridViewRow row = GridView1.SelectedRow;
            // string questionId = row.Cells[1].Text;
        }
    }
}
