<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddPersonalityQuestion.aspx.cs" Inherits="PPSystem.AddPersonalityQuestion" %>
    ...
    <asp:Panel ID="Panel1" runat="server" BackColor="White">
        ...
        <div class="page-container">
            ...
            <asp:Panel ID="Panel2" runat="server" CssClass="form-container">
                ...
                <!-- Heading Image -->
                <asp:Image ID="ImageHeading" runat="server" CssClass="heading-image" ImageUrl="~/Image/7.png" />
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="TBO5" runat="server"></asp:TextBox>
                </div>
